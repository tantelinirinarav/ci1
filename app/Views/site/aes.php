		...
		<div class="col-md-3">
				...
				<div style="text-align: center;
								...
								">
									...
									<div style="padding30px; color:white;">
										<a href="liste2" style="text-decoration:none; color:white; ">Licence 2</a>
									</div>
				...
				<div style="text-align: center;
					...
					">
						...
						<div style="padding30px; color:white;">
							<a href="liste3"  style="text-decoration:none; color:white; ">Licence 3</a>
						</div>
				...
				<div style="text-align: center;
					...
					">
						...
						<div style="padding30px; color:white;">
							<a href="liste4"  style="text-decoration:none; color:white; ">Master 1</a>
						</div>
				...
				<div style="text-align: center;
					...
					">
						...
						<div style="padding30px; color:white;">
							<a href="liste5"  style="text-decoration:none; color:white; ">Master 2</a>
						</div>
							...
							<th >MATRICULE</th><th>NOM </th><th>PRENOMS</th><th>NIVEAU</th><th>PARCOURS</th><th>ACTIONS</th>
								...
								?>	
											...
											<tr class="list-group-item-action " style="color:black; ">				
												...
												<a href="<?= base_url('edit/'.$u['matricule'])?>"    style="border: none; background-color: cadetblue; border-radius:8px; text-decoration:none; color:white;" > <img alt="" src="<?= site_url()?>/assets/img/manova_16.png"> Edit</a>

												<a href="<?= base_url('site/delete/'.$u['matricule']) ?>" onclick="confirm();" style="border: none; background-color: cadetblue; border-radius:8px; text-decoration:none; color:white;" > <img alt="" src="<?= site_url()?>/assets/img/mamafa_16.png"> Delete</a>
			...
			<!-- <script src="<?= site_url()?>/assets/js/apk1.js"></script> -->
