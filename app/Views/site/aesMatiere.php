		...
		<div class="col-md-3">
								...
								?>		
										<tr class="list-group-item-action " style="color:black; ">				
												<td><?php  $u['code'] ?></td>
												<td><?php  $u['nom_matiere'] ?></td>
												<td><?php  $u['nom_prof'] ?></td>
												<td><?php  $u['coef'] ?> </td>
												<td><?php  $u['niveauMat'] ?> </td>
				...
				<div style="text-align: center;
								...
								<a href="<?php echo site_url('listem') ?>"  
										  style="  border-radius:8px; text-decoration:none; color:white;" >Licence 1 
								</a>
				...
				<div style="text-align: center;
								...
								">
									...
									<div style="padding30px; color:white;">
										<a href="<?php echo site_url('liste2m') ?>" style="text-decoration:none; color:white; ">Licence 2</a>
									</div>
				...
				<div style="text-align: center;
					...
					">
						...
						<div style="padding30px; color:white;">
							<a href="<?php echo site_url('liste3m') ?>"  style="text-decoration:none; color:white; ">Licence 3</a>
						</div>
				...
				<div style="text-align: center;
					...
					">
						...
						<div style="padding30px; color:white;">
							<a href="<?php echo site_url('liste4m') ?>"  style="text-decoration:none; color:white; ">Master 1</a>
						</div>
				...
				<div style="text-align: center;
					...
					">
						...
						<div style="padding30px; color:white;">
							<a href="<?php echo site_url('liste5m') ?>"  style="text-decoration:none; color:white; ">Master 2</a>
						</div>
							...
							<th >CODE</th><th>NOM_MATIERE </th><th>PROF</th><th>COEFFICIENT</th><th>NIVEAU</th><th>ACTIONS</th>
								...
								?>		
											...
											<tr class="list-group-item-action " style="color:black; ">				
												...
												<a href="<?php echo site_url('site/edit/'.$u['idMat']) ?>"    style="border: none; background-color: cadetblue; border-radius:8px; text-decoration:none; color:white;" > <img alt="" src="public/img/manova_16.png"> Edit</a>

												<a href="<?= base_url('site/deleteMatiere/'.$u['idMat']) ?>" style="border: none; background-color: cadetblue; border-radius:8px; text-decoration:none; color:white;" > <img alt="" src="public/img/mamafa_16.png"> Delete</a>
			...
			<div class="text" Style="padding-left:800px; position:fixed;">
						...
						<a href="#modal" class="js-modal text-light "  style="text-decoration:none;" > <img alt="" src="public/img/ajout.ico"> Nouveau</a>
